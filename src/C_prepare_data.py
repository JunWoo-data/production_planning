...
def prepare_data(df, PLAN_START_DATE, PLAN_FINISH_DATE):
        ...
        df_basic_info.loc[df_basic_info["PART NUMBER"].str.split("-").str[1].str[:5].isin(["R5400", "CW000", "R5110"]), "num_wire"] = "2 wire"
        df_basic_info.loc[df_basic_info["PART NUMBER"].isin(df_line_info[df_line_info["LINE"].isin(["#3", "ALL"])]["PART NUMBER"]), "num_wire"] = "4 wire"
        df_basic_info.loc[df_basic_info["PART NUMBER"].str.split("-").str[1].str[:5].isin(["R5600", "R5100", "CW300"]), "num_wire"] = "4 wire"
